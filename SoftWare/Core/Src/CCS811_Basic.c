...
void configureCCS811()
{
	...
	if (hwID != 0x81)
	{
		uint8_t data[] = "CCS811 not found. Please check wiring.";
	...
	HAL_I2C_Master_Transmit(&hi2c1, 0xB6, lodata, 1, 100);
...
uint8_t readRegister(uint8_t addr)
{
	...
	HAL_I2C_Mem_Read( &hi2c1, CCS811_ADDRD, ( uint8_t )addr,1, &dt, 1,1000 );
	while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY);
